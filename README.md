...
Command-line todo list manager built with Node.js. Manage your tasks efficiently
from the terminal with features like adding, listing, completing, and deleting
todos.
